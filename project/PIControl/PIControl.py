...
class PIControl:
	...
	def __init__(self, pos_target: np.ndarray) -> None:
		self.PI_x = PIControl_base(Kp=0.2, Ki=0.002, Kb=0.05, Ts=0.05, xs=pos_target[0], u_min=-10.0, u_max=10.0)
		self.PI_y = PIControl_base(Kp=0.2, Ki=0.002, Kb=0.05, Ts=0.05, xs=pos_target[1], u_min=-10.0, u_max=10.0)
		self.PI_z = PIControl_base(Kp=0.2, Ki=0.002, Kb=0.05, Ts=0.05, xs=pos_target[2], u_min=-20.0, u_max=20.0)
